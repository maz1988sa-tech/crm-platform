...
(function (root) {
  ...
  root.APP_CONFIG = {
    ...
    /* ---------------------------------------------------------------
       المنتجات تحت مظلّة «إحراز»
       - إدارة العملاء والفرص تعمل من هنا مباشرة، ودخولها في هذه المنصة.
       - استقطاب المواهب منصّة مستقلّة لها خادمها ودخولها الخاص؛ نربطها
         برابط واحد فقط ولا نمسّ مشروعها إطلاقًا.
       - اترك الرابط فارغًا فيظهر للموظف تنبيه واضح بدل رابط ميّت.
       - عند بيع المنصة لعميل آخر يكفي تغيير هذا السطر (أو ضبط
         talent_url في env.js فيسبق ما هنا).
       --------------------------------------------------------------- */
    products: {
      /* منصة استقطاب المواهب: واجهتان على النطاق نفسه — واجهة الموظفين
         وواجهة المدير لاعتماد المرشّحين. الدور يقرّر أيّهما. */
      talent_url: ENV.talent_url || 'https://alramsat-talent.pages.dev',
      talent_manager_url: ENV.talent_manager_url || 'https://alramsat-talent.pages.dev/rami'
    },
